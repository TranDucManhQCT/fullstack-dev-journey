...
Khi xem những repository nổi tiếng trên GitHub, bạn gần như sẽ luôn bắt gặp một file tên là `README.md`.
...
Khi bạn viết bằng Markdown, nội dung thực chất được lưu dưới dạng **văn bản thuần** trong một tệp có phần mở rộng như `.md` hoặc `.markdown`.

Nhưng một tệp Markdown tự nó chưa phải là thứ trình duyệt có thể hiển thị đẹp ngay. Để nội dung đó xuất hiện dưới dạng một trang web, tài liệu HTML hoặc PDF, bạn cần trình biên dịch xử lý.Markdown thường hoạt động theo 4 bước:
